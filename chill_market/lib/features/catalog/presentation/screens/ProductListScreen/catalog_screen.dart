  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: RefreshIndicator(
        onRefresh: () async {
          return BlocProvider.of<ProductListBloc>(
            context,
          ).add(GetListProduct());
        },
                ...
                child: PageView.builder(
                  ...
                  itemBuilder: (context, index) {
                    final List<String> images = [
                      'assets/img/frame_one.png',
                      'assets/img/frame_tree.png',
                      'assets/img/frame_two.png',
                    ];
                    return Padding(
                  ...
                  return GestureDetector(
                    onTap: () {
                      BlocProvider.of<CategoryBloc>(context).add(
                        CategorySearchBySlug(
                          slug: categoryProducts.values.toList()[index],
                        ),
                      );
                      Navigator.push(
                        context,
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Text(
                          categoryProducts.keys.toList()[index],
                          style: TextStyle(
                            color: Colors.black,
                    ...
                    onTap: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder:
                              (context) =>
                                  ProductScreen(id: widget.products[index].id),
                        ),
                      );
                    },
                    child: Container(
